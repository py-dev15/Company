    ...
    <Container className="mt-5 text-center">
      ...
      <Row className="mt-5">
        <Col>
          ...
          <p>
            The Digital Marketing Pulse was started in 2020 as a startup with a small team with high passion and skills solving problems and increasing customer satisfaction as their key goal. In the future, we are planning to expand our service to other countries.
          </p>
        </Col>
      </Row>
